...
void loop() {
  ...
  analogWrite(5,100);       // Pin 5 is connected to Timer Counter 0; default f = 976 Hz  
  analogWrite(6,100);       // Pin 6 is connected to Timer Counter 0; default f = 976 Hz
  ...
  analogWrite(3,100);       // Pin 3 is connected to Timer Counter 2; default f = 488 Hz
  analogWrite(11,100);      // Pin 11 is connected to Timer counter 2; default f = 488 Hz
